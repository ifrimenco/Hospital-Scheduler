...
namespace HospitalScheduler.DataAccess.Migrations
{
    ...
    [Migration("20201207122356_BackToOfficeReloaded")]
    partial class BackToOfficeReloaded
    {
            ...
            modelBuilder.Entity("HospitalScheduler.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            GenderId = 3,
                            LastName = "",
                            PasswordHash = "Tlyaf2EqL+7dx4Nta9jUEfB/xJhoDc52FOZWioiQH8soZGQyf6/kqfu+dogV1Gn3"
                        });
                });
